*Sawaya epsilon reformulation G(x,z) = ((1-es)*z+es)*g(x / ((1-es)*z+es) ) - es*g(0)*(1-z)*Retrofit-Synthesis Problem with 8 retrofit processes and 40 synthesis processes
*Three Periods (t=3)
*Convex-Hull Version
...
DISJ_1_1_31(T).. V('71','1','31',T) =L= ((1-ES)*Z('31',T)+ES)*(1.1*LOG(1 + V('65','1','31',T)/((1-ES)*Z('31',T)+ES)));
...
DISJ_1_1_33(T).. V('83','1','33',T) =L= ((1-ES)*Z('33',T)+ES)*(1*LOG(1 + V('67','1','33',T)/((1-ES)*Z('33',T)+ES)));
...
DISJ_1_1_34(T).. V('84','1','34',T) =L= ((1-ES)*Z('34',T)+ES)*(0.7*LOG(1 + V('72','1','34',T)/((1-ES)*Z('34',T)+ES)));
...
DISJ_1_1_35(T).. V('85','1','35',T) =L= ((1-ES)*Z('35',T)+ES)*(0.65*LOG(1 + V('73','1','35',T)/((1-ES)*Z('35',T)+ES)));
*DISJ_2_1_35(T).. (Z('35',T)+ES)*(V('85','1','35',T)/(Z('35',T)+ES) - 0.65*LOG(1+(V('76','1','35',T))/(Z('35',T)+ES))) =L= 0;
DISJ_2_1_35(T).. V('85','1','35',T) =L= ((1-ES)*Z('35',T)+ES)*(0.65*LOG(1 + V('76','1','35',T)/((1-ES)*Z('35',T)+ES)));
...
DISJ_1_1_38(T).. V('88','1','38',T) =L= ((1-ES)*Z('38',T)+ES)*(0.75*LOG(1 + V('79','1','38',T)/((1-ES)*Z('38',T)+ES)));
...
DISJ_1_1_39(T).. V('89','1','39',T) =L= ((1-ES)*Z('39',T)+ES)*(0.8*LOG(1 + V('80','1','39',T)/((1-ES)*Z('39',T)+ES)));
...
DISJ_1_1_40(T).. V('90','1','40',T) =L= ((1-ES)*Z('40',T)+ES)*(0.85*LOG(1 + V('81','1','40',T)/((1-ES)*Z('40',T)+ES)));
