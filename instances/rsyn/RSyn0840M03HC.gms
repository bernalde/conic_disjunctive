...
positive variable X_DISJ_1_1_31(T), Y_DISJ_1_1_31(T);
X_DISJ_1_1_31.up(T) = UB('71','1','31',T)/(1.1*1);
Y_DISJ_1_1_31.up(T) = UB('65','1','31',T) + 1;
equation d_DISJ_1_1_31(T);
equation c_DISJ_1_1_31(T);
Z.l('31',T) = 1;
DISJ_1_1_31(T).. Y_DISJ_1_1_31(T) =G= Z('31',T)*exp(X_DISJ_1_1_31(T)/Z('31',T));
c_DISJ_1_1_31(T).. X_DISJ_1_1_31(T) =G= V('71','1','31',T)/(1.1*1);
d_DISJ_1_1_31(T).. Y_DISJ_1_1_31(T) =E= Z('31',T)+V('65','1','31',T);
...
positive variable X_DISJ_1_1_33(T), Y_DISJ_1_1_33(T);
X_DISJ_1_1_33.up(T) = UB('83','1','33',T)/(1*1);
Y_DISJ_1_1_33.up(T) = UB('67','1','33',T) + 1;
equation d_DISJ_1_1_33(T);
equation c_DISJ_1_1_33(T);
Z.l('33',T) = 1;
DISJ_1_1_33(T).. Y_DISJ_1_1_33(T) =G= Z('33',T)*exp(X_DISJ_1_1_33(T)/Z('33',T));
c_DISJ_1_1_33(T).. X_DISJ_1_1_33(T) =G= V('83','1','33',T)/(1*1);
d_DISJ_1_1_33(T).. Y_DISJ_1_1_33(T) =E= Z('33',T)+V('67','1','33',T);
...
positive variable X_DISJ_1_1_34(T), Y_DISJ_1_1_34(T);
X_DISJ_1_1_34.up(T) = UB('84','1','34',T)/(0.7*1);
Y_DISJ_1_1_34.up(T) = UB('72','1','34',T) + 1;
equation d_DISJ_1_1_34(T);
equation c_DISJ_1_1_34(T);
Z.l('34',T) = 1;
DISJ_1_1_34(T).. Y_DISJ_1_1_34(T) =G= Z('34',T)*exp(X_DISJ_1_1_34(T)/Z('34',T));
c_DISJ_1_1_34(T).. X_DISJ_1_1_34(T) =G= V('84','1','34',T)/(0.7*1);
d_DISJ_1_1_34(T).. Y_DISJ_1_1_34(T) =E= Z('34',T)+V('72','1','34',T);
...
positive variable X_DISJ_1_1_35(T), Y_DISJ_1_1_35(T);
X_DISJ_1_1_35.up(T) = UB('85','1','35',T)/(0.65*1);
Y_DISJ_1_1_35.up(T) = UB('73','1','35',T) + 1;
equation d_DISJ_1_1_35(T);
equation c_DISJ_1_1_35(T);
Z.l('35',T) = 1;
DISJ_1_1_35(T).. Y_DISJ_1_1_35(T) =G= Z('35',T)*exp(X_DISJ_1_1_35(T)/Z('35',T));
c_DISJ_1_1_35(T).. X_DISJ_1_1_35(T) =G= V('85','1','35',T)/(0.65*1);
d_DISJ_1_1_35(T).. Y_DISJ_1_1_35(T) =E= Z('35',T)+V('73','1','35',T);
*DISJ_2_1_35(T).. (Z('35',T)+ES)*(V('85','1','35',T)/(Z('35',T)+ES) - 0.65*LOG(1+(V('76','1','35',T))/(Z('35',T)+ES))) =L= 0;
positive variable X_DISJ_2_1_35(T), Y_DISJ_2_1_35(T);
X_DISJ_2_1_35.up(T) = UB('85','1','35',T)/(0.65*1);
Y_DISJ_2_1_35.up(T) = UB('76','1','35',T) + 1;
equation d_DISJ_2_1_35(T);
equation c_DISJ_2_1_35(T);
binary variable Z35(T);
equation Z35_eq(T);
Z35.l(T) = 1;
Z35_eq(T).. Z35(T) =E= Z('35',T);
DISJ_2_1_35(T).. Y_DISJ_2_1_35(T) =G= Z35(T)*exp(X_DISJ_2_1_35(T)/Z35(T));
c_DISJ_2_1_35(T).. X_DISJ_2_1_35(T) =G= V('85','1','35',T)/(0.65*1);
d_DISJ_2_1_35(T).. Y_DISJ_2_1_35(T) =E= Z35(T)+V('76','1','35',T);
...
positive variable X_DISJ_1_1_38(T), Y_DISJ_1_1_38(T);
X_DISJ_1_1_38.up(T) = UB('88','1','38',T)/(0.75*1);
Y_DISJ_1_1_38.up(T) = UB('79','1','38',T) + 1;
equation d_DISJ_1_1_38(T);
equation c_DISJ_1_1_38(T);
Z.l('38',T) = 1;
DISJ_1_1_38(T).. Y_DISJ_1_1_38(T) =G= Z('38',T)*exp(X_DISJ_1_1_38(T)/Z('38',T));
c_DISJ_1_1_38(T).. X_DISJ_1_1_38(T) =G= V('88','1','38',T)/(0.75*1);
d_DISJ_1_1_38(T).. Y_DISJ_1_1_38(T) =E= Z('38',T)+V('79','1','38',T);
...
positive variable X_DISJ_1_1_39(T), Y_DISJ_1_1_39(T);
X_DISJ_1_1_39.up(T) = UB('89','1','39',T)/(0.8*1);
Y_DISJ_1_1_39.up(T) = UB('80','1','39',T) + 1;
equation d_DISJ_1_1_39(T);
equation c_DISJ_1_1_39(T);
Z.l('39',T) = 1;
DISJ_1_1_39(T).. Y_DISJ_1_1_39(T) =G= Z('39',T)*exp(X_DISJ_1_1_39(T)/Z('39',T));
c_DISJ_1_1_39(T).. X_DISJ_1_1_39(T) =G= V('89','1','39',T)/(0.8*1);
d_DISJ_1_1_39(T).. Y_DISJ_1_1_39(T) =E= Z('39',T)+V('80','1','39',T);
...
positive variable X_DISJ_1_1_40(T), Y_DISJ_1_1_40(T);
X_DISJ_1_1_40.up(T) = UB('90','1','40',T)/(0.85*1);
Y_DISJ_1_1_40.up(T) = UB('81','1','40',T) + 1;
equation d_DISJ_1_1_40(T);
equation c_DISJ_1_1_40(T);
Z.l('40',T) = 1;
DISJ_1_1_40(T).. Y_DISJ_1_1_40(T) =G= Z('40',T)*exp(X_DISJ_1_1_40(T)/Z('40',T));
c_DISJ_1_1_40(T).. X_DISJ_1_1_40(T) =G= V('90','1','40',T)/(0.85*1);
d_DISJ_1_1_40(T).. Y_DISJ_1_1_40(T) =E= Z('40',T)+V('81','1','40',T);
