...
PARAMETERS BIGM(E,D,I,T) /1*4 .1*2 .1*40 .1*2 = 0/;
...
*SOLVE RETRO_8_SYNTH_40_MULTI_BIGM USING RMINLP MAXIMIZING obj;

RETRO_8_SYNTH_40_MULTI_BIGM.NODLIM = 1000000;
RETRO_8_SYNTH_40_MULTI_BIGM.OPTFILE = 1;

SOLVE RETRO_8_SYNTH_40_MULTI_BIGM USING MINLP MAXIMIZING obj;