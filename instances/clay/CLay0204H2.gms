...
*HRL
*SAF1(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  - 2*(L(I)/2 + XBAR(AREA))*U(AREA,I) + 2*(H(I)/2 - YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 + XBAR(AREA)) + SQR(H(I)/2 - YBAR(AREA)) - SQR(R(AREA))) =L= 0;
*SAF2(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  - 2*(L(I)/2 + XBAR(AREA))*U(AREA,I) - 2*(H(I)/2 + YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 + XBAR(AREA)) + SQR(H(I)/2 + YBAR(AREA)) - SQR(R(AREA))) =L= 0;
*SAF3(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  + 2*(L(I)/2 - XBAR(AREA))*U(AREA,I) + 2*(H(I)/2 - YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 - XBAR(AREA)) + SQR(H(I)/2 - YBAR(AREA)) - SQR(R(AREA))) =L= 0;
*SAF4(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  + 2*(L(I)/2 - XBAR(AREA))*U(AREA,I) - 2*(H(I)/2 + YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 - XBAR(AREA)) + SQR(H(I)/2 + YBAR(AREA)) - SQR(R(AREA))) =L= 0;

*HR
*SAF1(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)*(1-ES)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  - 2*(L(I)/2 + XBAR(AREA))*U(AREA,I) + 2*(H(I)/2 - YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 + XBAR(AREA)) + SQR(H(I)/2 - YBAR(AREA)) - SQR(R(AREA))) =L= 0;
*SAF2(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)*(1-ES)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  - 2*(L(I)/2 + XBAR(AREA))*U(AREA,I) - 2*(H(I)/2 + YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 + XBAR(AREA)) + SQR(H(I)/2 + YBAR(AREA)) - SQR(R(AREA))) =L= 0;
*SAF3(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)*(1-ES)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  + 2*(L(I)/2 - XBAR(AREA))*U(AREA,I) + 2*(H(I)/2 - YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 - XBAR(AREA)) + SQR(H(I)/2 - YBAR(AREA)) - SQR(R(AREA))) =L= 0;
*SAF4(AREA,I).. SQR(U(AREA,I))/(W(AREA,I)*(1-ES)+ES) + SQR(UU(AREA,I))/(W(AREA,I)+ES)  + 2*(L(I)/2 - XBAR(AREA))*U(AREA,I) - 2*(H(I)/2 + YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 - XBAR(AREA)) + SQR(H(I)/2 + YBAR(AREA)) - SQR(R(AREA))) =L= 0;
...
SAF3(AREA,I).. T(AREA,I) + 2*(L(I)/2 - XBAR(AREA))*U(AREA,I) + 2*(H(I)/2 - YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 - XBAR(AREA)) + SQR(H(I)/2 - YBAR(AREA)) - SQR(R(AREA))) =L= 0;
SAF4(AREA,I).. T(AREA,I) + 2*(L(I)/2 - XBAR(AREA))*U(AREA,I) - 2*(H(I)/2 + YBAR(AREA))*UU(AREA,I) + W(AREA,I)*(SQR(L(I)/2 - XBAR(AREA)) + SQR(H(I)/2 + YBAR(AREA)) - SQR(R(AREA))) =L= 0;
SAF_c(AREA,I).. SQR(W(AREA,I) + T(AREA,I)) =G= 4*SQR(U(AREA,I)) + 4*SQR(UU(AREA,I)) + SQR(W(AREA,I) - T(AREA,I));
