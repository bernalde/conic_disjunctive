*Constrained Layout Problem with 4 rectangles and 3 areas
*Big-M version
...
M2('1','3','1') = SQR(XMIN('1') - L('1')/2 - XBAR('3')) + SQR(YMIN('1') + H('1')/2 - YBAR('3')) - SQR(R('3'));
M2('2','3','1') = SQR(XMIN('1') - L('1')/2 - XBAR('3')) + SQR(YMIN('1') - H('1')/2 - YBAR('3')) - SQR(R('3'));
...
M2('1','3','2') = SQR(XMIN('2') - L('2')/2 - XBAR('3')) + SQR(YMIN('2') + H('2')/2 - YBAR('3')) - SQR(R('3'));
M2('2','3','2') = SQR(XMIN('2') - L('2')/2 - XBAR('3')) + SQR(YMIN('2') - H('2')/2 - YBAR('3')) - SQR(R('3'));
