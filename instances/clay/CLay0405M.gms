...
M2('1','3','1') = SQR(XMAX('1') - L('1')/2 - XBAR('3')) + SQR(YMIN('1') + H('1')/2 - YBAR('3')) - SQR(R('3'));
M2('2','3','1') = SQR(XMAX('1') - L('1')/2 - XBAR('3')) + SQR(YMIN('1') - H('1')/2 - YBAR('3')) - SQR(R('3'));
M2('3','3','1') = SQR(XMAX('1') + L('1')/2 - XBAR('3')) + SQR(YMIN('1') + H('1')/2 - YBAR('3')) - SQR(R('3'));
M2('4','3','1') = SQR(XMAX('1') + L('1')/2 - XBAR('3')) + SQR(YMIN('1') - H('1')/2 - YBAR('3')) - SQR(R('3'));
...
M2('1','3','2') = SQR(XMAX('2') - L('2')/2 - XBAR('3')) + SQR(YMIN('2') + H('2')/2 - YBAR('3')) - SQR(R('3'));
M2('2','3','2') = SQR(XMAX('2') - L('2')/2 - XBAR('3')) + SQR(YMIN('2') - H('2')/2 - YBAR('3')) - SQR(R('3'));
M2('3','3','2') = SQR(XMAX('2') + L('2')/2 - XBAR('3')) + SQR(YMIN('2') + H('2')/2 - YBAR('3')) - SQR(R('3'));
M2('4','3','2') = SQR(XMAX('2') + L('2')/2 - XBAR('3')) + SQR(YMIN('2') - H('2')/2 - YBAR('3')) - SQR(R('3'));
...
M2('1','2','3') = SQR(XMIN('3') - L('3')/2 - XBAR('2')) + SQR(YMIN('3') + H('3')/2 - YBAR('2')) - SQR(R('2'));
M2('2','2','3') = SQR(XMIN('3') - L('3')/2 - XBAR('2')) + SQR(YMIN('3') - H('3')/2 - YBAR('2')) - SQR(R('2'));
M2('3','2','3') = SQR(XMIN('3') + L('3')/2 - XBAR('2')) + SQR(YMIN('3') + H('3')/2 - YBAR('2')) - SQR(R('2'));
M2('4','2','3') = SQR(XMIN('3') + L('3')/2 - XBAR('2')) + SQR(YMIN('3') - H('3')/2 - YBAR('2')) - SQR(R('2'));

M2('1','3','3') = SQR(XMAX('3') - L('3')/2 - XBAR('3')) + SQR(YMIN('3') + H('3')/2 - YBAR('3')) - SQR(R('3'));
M2('2','3','3') = SQR(XMAX('3') - L('3')/2 - XBAR('3')) + SQR(YMIN('3') - H('3')/2 - YBAR('3')) - SQR(R('3'));
M2('3','3','3') = SQR(XMAX('3') + L('3')/2 - XBAR('3')) + SQR(YMIN('3') + H('3')/2 - YBAR('3')) - SQR(R('3'));
M2('4','3','3') = SQR(XMAX('3') + L('3')/2 - XBAR('3')) + SQR(YMIN('3') - H('3')/2 - YBAR('3')) - SQR(R('3'));
...
M2('1','3','4') = SQR(XMAX('4') - L('4')/2 - XBAR('3')) + SQR(YMIN('4') + H('4')/2 - YBAR('3')) - SQR(R('3'));
M2('2','3','4') = SQR(XMAX('4') - L('4')/2 - XBAR('3')) + SQR(YMIN('4') - H('4')/2 - YBAR('3')) - SQR(R('3'));
M2('3','3','4') = SQR(XMAX('4') + L('4')/2 - XBAR('3')) + SQR(YMIN('4') + H('4')/2 - YBAR('3')) - SQR(R('3'));
M2('4','3','4') = SQR(XMAX('4') + L('4')/2 - XBAR('3')) + SQR(YMIN('4') - H('4')/2 - YBAR('3')) - SQR(R('3'));
...
M2('1','3','5') = SQR(XMAX('5') - L('5')/2 - XBAR('3')) + SQR(YMAX('5') + H('5')/2 - YBAR('3')) - SQR(R('3'));
M2('2','3','5') = SQR(XMAX('5') - L('5')/2 - XBAR('3')) + SQR(YMIN('5') - H('5')/2 - YBAR('3')) - SQR(R('3'));
M2('3','3','5') = SQR(XMAX('5') + L('5')/2 - XBAR('3')) + SQR(YMAX('5') + H('5')/2 - YBAR('3')) - SQR(R('3'));
M2('4','3','5') = SQR(XMAX('5') + L('5')/2 - XBAR('3')) + SQR(YMIN('5') - H('5')/2 - YBAR('3')) - SQR(R('3'));
