...
PARAMETER UB(K,D,I,T) /1*90 .1*2 .1*40 .1*3= 0/;
...
positive variable X_DISJ_1_1_11(T);
...
c_DISJ_1_1_11(T).. X_DISJ_1_1_11(T)*(1.1*Z('11',T)) =G= V('26','1','11',T);
...
positive variable X_DISJ_1_1_14(T);
...
c_DISJ_1_1_14(T).. X_DISJ_1_1_14(T)*(0.7*Z('14',T)) =G= V('39','1','14',T);
...
positive variable X_DISJ_1_1_15(T);
...
c_DISJ_1_1_15(T).. X_DISJ_1_1_15(T)*(0.65*Z('15',T)) =G= V('40','1','15',T);
*DISJ_2_1_15(T).. (Z('15',T)+ES)*(V('40','1','15',T)/(Z('15',T)+ES) - 0.65*LOG(1+(V('31','1','15',T))/(Z('15',T)+ES))) =L= 0;
positive variable X_DISJ_2_1_15(T);
...
c_DISJ_2_1_15(T).. X_DISJ_2_1_15(T)*(0.65*Z('15',T)) =G= V('40','1','15',T);
...
positive variable X_DISJ_1_1_18(T);
X_DISJ_1_1_18.up(T) = UB('43','1','18',T)/(0.75*1);
equation c_DISJ_1_1_18(T);
DISJ_1_1_18(T).. Z('18',T)+V('34','1','18',T) =G= Z('18',T)*exp(X_DISJ_1_1_18(T));
c_DISJ_1_1_18(T).. X_DISJ_1_1_18(T)*(0.75*Z('18',T)) =G= V('43','1','18',T);
...
positive variable X_DISJ_1_1_19(T);
X_DISJ_1_1_19.up(T) = UB('44','1','19',T)/(0.8*1);
equation c_DISJ_1_1_19(T);
DISJ_1_1_19(T).. Z('19',T)+V('35','1','19',T) =G= Z('19',T)*exp(X_DISJ_1_1_19(T));
c_DISJ_1_1_19(T).. X_DISJ_1_1_19(T)*(0.8*Z('19',T)) =G= V('44','1','19',T);
...
positive variable X_DISJ_1_1_20(T);
X_DISJ_1_1_20.up(T) = UB('45','1','20',T)/(0.85*1);
equation c_DISJ_1_1_20(T);
DISJ_1_1_20(T).. Z('20',T)+V('36','1','20',T) =G= Z('20',T)*exp(X_DISJ_1_1_20(T));
c_DISJ_1_1_20(T).. X_DISJ_1_1_20(T)*(0.85*Z('20',T)) =G= V('45','1','20',T);
...
positive variable X_DISJ_1_1_21(T);
X_DISJ_1_1_21.up(T) = UB('49','1','21',T)/(1*1);
equation c_DISJ_1_1_21(T);
DISJ_1_1_21(T).. Z('21',T)+V('47','1','21',T) =G= Z('21',T)*exp(X_DISJ_1_1_21(T));
c_DISJ_1_1_21(T).. X_DISJ_1_1_21(T)*(1*Z('21',T)) =G= V('49','1','21',T);
...
positive variable X_DISJ_1_1_22(T);
X_DISJ_1_1_22.up(T) = UB('50','1','22',T)/(1.2*1);
equation c_DISJ_1_1_22(T);
DISJ_1_1_22(T).. Z('22',T)+V('48','1','22',T) =G= Z('22',T)*exp(X_DISJ_1_1_22(T));
c_DISJ_1_1_22(T).. X_DISJ_1_1_22(T)*(1.2*Z('22',T)) =G= V('50','1','22',T);
...
positive variable X_DISJ_1_1_24(T);
X_DISJ_1_1_24.up(T) = UB('59','1','24',T)/(1.5*1);
equation c_DISJ_1_1_24(T);
DISJ_1_1_24(T).. Z('24',T)+V('55','1','24',T) =G= Z('24',T)*exp(X_DISJ_1_1_24(T));
c_DISJ_1_1_24(T).. X_DISJ_1_1_24(T)*(1.5*Z('24',T)) =G= V('59','1','24',T);
...
positive variable X_DISJ_1_1_26(T);
X_DISJ_1_1_26.up(T) = UB('66','1','26',T)/(1.25*1);
equation c_DISJ_1_1_26(T);
DISJ_1_1_26(T).. Z('26',T)+V('61','1','26',T) =G= Z('26',T)*exp(X_DISJ_1_1_26(T));
c_DISJ_1_1_26(T).. X_DISJ_1_1_26(T)*(1.25*Z('26',T)) =G= V('66','1','26',T);
...
positive variable X_DISJ_1_1_27(T);
X_DISJ_1_1_27.up(T) = UB('67','1','27',T)/(0.9*1);
equation c_DISJ_1_1_27(T);
DISJ_1_1_27(T).. Z('27',T)+V('62','1','27',T) =G= Z('27',T)*exp(X_DISJ_1_1_27(T));
c_DISJ_1_1_27(T).. X_DISJ_1_1_27(T)*(0.9*Z('27',T)) =G= V('67','1','27',T);
...
positive variable X_DISJ_1_1_28(T);
X_DISJ_1_1_28.up(T) = UB('68','1','28',T)/(1*1);
equation c_DISJ_1_1_28(T);
DISJ_1_1_28(T).. Z('28',T)+V('59','1','28',T) =G= Z('28',T)*exp(X_DISJ_1_1_28(T));
c_DISJ_1_1_28(T).. X_DISJ_1_1_28(T)*(1*Z('28',T)) =G= V('68','1','28',T);
...
positive variable X_DISJ_1_1_31(T);
X_DISJ_1_1_31.up(T) = UB('71','1','31',T)/(1.1*1);
equation c_DISJ_1_1_31(T);
DISJ_1_1_31(T).. Z('31',T)+V('65','1','31',T) =G= Z('31',T)*exp(X_DISJ_1_1_31(T));
c_DISJ_1_1_31(T).. X_DISJ_1_1_31(T)*(1.1*Z('31',T)) =G= V('71','1','31',T);
...
positive variable X_DISJ_1_1_33(T);
X_DISJ_1_1_33.up(T) = UB('83','1','33',T)/(1*1);
equation c_DISJ_1_1_33(T);
DISJ_1_1_33(T).. Z('33',T)+V('67','1','33',T) =G= Z('33',T)*exp(X_DISJ_1_1_33(T));
c_DISJ_1_1_33(T).. X_DISJ_1_1_33(T)*(1*Z('33',T)) =G= V('83','1','33',T);
...
positive variable X_DISJ_1_1_34(T);
X_DISJ_1_1_34.up(T) = UB('84','1','34',T)/(0.7*1);
equation c_DISJ_1_1_34(T);
DISJ_1_1_34(T).. Z('34',T)+V('72','1','34',T) =G= Z('34',T)*exp(X_DISJ_1_1_34(T));
c_DISJ_1_1_34(T).. X_DISJ_1_1_34(T)*(0.7*Z('34',T)) =G= V('84','1','34',T);
...
positive variable X_DISJ_1_1_35(T);
X_DISJ_1_1_35.up(T) = UB('85','1','35',T)/(0.65*1);
equation c_DISJ_1_1_35(T);
DISJ_1_1_35(T).. Z('35',T)+V('73','1','35',T) =G= Z('35',T)*exp(X_DISJ_1_1_35(T));
c_DISJ_1_1_35(T).. X_DISJ_1_1_35(T)*(0.65*Z('35',T)) =G= V('85','1','35',T);
*DISJ_2_1_35(T).. (Z('35',T)+ES)*(V('85','1','35',T)/(Z('35',T)+ES) - 0.65*LOG(1+(V('76','1','35',T))/(Z('35',T)+ES))) =L= 0;
positive variable X_DISJ_2_1_35(T);
X_DISJ_2_1_35.up(T) = UB('85','1','35',T)/(0.65*1);
equation c_DISJ_2_1_35(T);
DISJ_2_1_35(T).. Z('35',T)+V('76','1','35',T) =G= Z('35',T)*exp(X_DISJ_2_1_35(T));
c_DISJ_2_1_35(T).. X_DISJ_2_1_35(T)*(0.65*Z('35',T)) =G= V('85','1','35',T);
...
positive variable X_DISJ_1_1_38(T);
X_DISJ_1_1_38.up(T) = UB('88','1','38',T)/(0.75*1);
equation c_DISJ_1_1_38(T);
DISJ_1_1_38(T).. Z('38',T)+V('79','1','38',T) =G= Z('38',T)*exp(X_DISJ_1_1_38(T));
c_DISJ_1_1_38(T).. X_DISJ_1_1_38(T)*(0.75*Z('38',T)) =G= V('88','1','38',T);
...
positive variable X_DISJ_1_1_39(T);
X_DISJ_1_1_39.up(T) = UB('89','1','39',T)/(0.8*1);
equation c_DISJ_1_1_39(T);
DISJ_1_1_39(T).. Z('39',T)+V('80','1','39',T) =G= Z('39',T)*exp(X_DISJ_1_1_39(T));
c_DISJ_1_1_39(T).. X_DISJ_1_1_39(T)*(0.8*Z('39',T)) =G= V('89','1','39',T);
...
positive variable X_DISJ_1_1_40(T);
X_DISJ_1_1_40.up(T) = UB('90','1','40',T)/(0.85*1);
equation c_DISJ_1_1_40(T);
DISJ_1_1_40(T).. Z('40',T)+V('81','1','40',T) =G= Z('40',T)*exp(X_DISJ_1_1_40(T));
c_DISJ_1_1_40(T).. X_DISJ_1_1_40(T)*(0.85*Z('40',T)) =G= V('90','1','40',T);
