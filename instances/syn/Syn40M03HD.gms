...
positive variable X_DISJ_1_1_18(T), W_DISJ_1_1_18(T);
...
c_DISJ_1_1_18(T).. 0.75*W_DISJ_1_1_18(T) =G= V('43','1','18',T);
...
positive variable X_DISJ_1_1_19(T), W_DISJ_1_1_19(T);
...
c_DISJ_1_1_19(T).. 0.8*W_DISJ_1_1_19(T) =G= V('44','1','19',T);
...
positive variable X_DISJ_1_1_20(T), W_DISJ_1_1_20(T);
...
c_DISJ_1_1_20(T).. 0.85*W_DISJ_1_1_20(T) =G= V('45','1','20',T);
...
positive variable X_DISJ_1_1_21(T), W_DISJ_1_1_21(T);
...
c_DISJ_1_1_21(T).. 1*W_DISJ_1_1_21(T) =G= V('49','1','21',T);
...
positive variable X_DISJ_1_1_22(T), W_DISJ_1_1_22(T);
...
c_DISJ_1_1_22(T).. 1.2*W_DISJ_1_1_22(T) =G= V('50','1','22',T);
...
positive variable X_DISJ_1_1_24(T), W_DISJ_1_1_24(T);
...
c_DISJ_1_1_24(T).. 1.5*W_DISJ_1_1_24(T) =G= V('59','1','24',T);
...
positive variable X_DISJ_1_1_26(T), W_DISJ_1_1_26(T);
...
c_DISJ_1_1_26(T).. 1.25*W_DISJ_1_1_26(T) =G= V('66','1','26',T);
...
positive variable X_DISJ_1_1_27(T), W_DISJ_1_1_27(T);
...
c_DISJ_1_1_27(T).. 0.9*W_DISJ_1_1_27(T) =G= V('67','1','27',T);
...
positive variable X_DISJ_1_1_28(T), W_DISJ_1_1_28(T);
...
c_DISJ_1_1_28(T).. 1*W_DISJ_1_1_28(T) =G= V('68','1','28',T);
...
positive variable X_DISJ_1_1_31(T), W_DISJ_1_1_31(T);
...
c_DISJ_1_1_31(T).. 1.1*W_DISJ_1_1_31(T) =G= V('71','1','31',T);
...
positive variable X_DISJ_1_1_33(T), W_DISJ_1_1_33(T);
...
c_DISJ_1_1_33(T).. 1*W_DISJ_1_1_33(T) =G= V('83','1','33',T);
...
positive variable X_DISJ_1_1_34(T), W_DISJ_1_1_34(T);
...
c_DISJ_1_1_34(T).. 0.7*W_DISJ_1_1_34(T) =G= V('84','1','34',T);
...
positive variable X_DISJ_1_1_35(T), W_DISJ_1_1_35(T);
...
c_DISJ_1_1_35(T).. 0.65*W_DISJ_1_1_35(T) =G= V('85','1','35',T);
...
positive variable X_DISJ_2_1_35(T), W_DISJ_2_1_35(T);
...
c_DISJ_2_1_35(T).. 0.65*W_DISJ_2_1_35(T) =G= V('85','1','35',T);
...
positive variable X_DISJ_1_1_38(T), W_DISJ_1_1_38(T);
...
c_DISJ_1_1_38(T).. 0.75*W_DISJ_1_1_38(T) =G= V('88','1','38',T);
...
positive variable X_DISJ_1_1_39(T), W_DISJ_1_1_39(T);
...
c_DISJ_1_1_39(T).. 0.8*W_DISJ_1_1_39(T) =G= V('89','1','39',T);
...
positive variable X_DISJ_1_1_40(T), W_DISJ_1_1_40(T);
...
c_DISJ_1_1_40(T).. 0.85*W_DISJ_1_1_40(T) =G= V('90','1','40',T);
